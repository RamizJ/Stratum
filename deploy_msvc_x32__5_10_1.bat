set depoy_dir=Stratum_msvc_x32
set source_dir=build-Stratum-Desktop_Qt_5_10_1_MSVC2015_32bit-Release
set qt_dir=c:\Qt\5.10.1\msvc2015\bin\
set qt_plugins_dir=c:\Qt\5.10.1\msvc2015\plugins\
