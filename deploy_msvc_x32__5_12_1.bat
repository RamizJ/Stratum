...
set source_dir=build-Stratum-Desktop_Qt_5_12_1_MSVC2017_32bit-Release
set qt_dir=c:\Qt\5.12.1\msvc2017\bin\
set qt_plugins_dir=c:\Qt\5.12.1\msvc2017\plugins\
