...
public:
    ...
    static HBITMAP rotate(HBITMAP, double, int, bool);
    static HBITMAP rotate(HBITMAP, double, bool);
    static HBITMAP rotate(HBITMAP, double, int);
private:
    static double coss;
    static double sins;
...
{
    return rotate(src, rotation, NULL, bgcolor, autoblend);
}

HBITMAP aarot::rotate(HBITMAP src, double rotation, bool autoblend)
{
    return rotate(src, rotation, NULL, 0x00FFFFFF, autoblend);
}

HBITMAP aarot::rotate(HBITMAP src, double rotation, int bgcolor)
{
    return rotate(src, rotation, NULL, bgcolor, true);
}
